$(function () {
    ...
    var d4 = [];
    for (var i = 1; i <= 12; i += 1) {
        d4.push([i, parseInt((Math.floor(Math.random() * (1 + 55 - 9))) + 10)]);
    }

    var d11 = [[0, 0], [1, 8.11], [2, 6.5], [3, 4.98], [4, 3.7], [5, 6.2], [6, 4.8], [7, 8.2], [8, 6.5], [9, 4.98], [10, 3.7], [11, 6.2], [12, 4.8]];
    var d12 = [[0, 0], [1, 9.21], [2, 8.5], [3, 4.98], [4, 6.7], [5, 5.2], [6, 5.4], [7, 9.2], [8, 8.5], [9, 4.98], [10, 6.7], [11, 5.2], [12, 5.4]];
    var d13 = [[0, 0], [1, 7.54], [2, 7.5], [3, 7.98], [4, 7.7], [5, 7.2], [6, 3.8], [7, 7.2], [8, 7.5], [9, 7.98], [10, 7.7], [11, 7.2], [12, 3.8]];

    function xAxisLabelGenerator(x) {
        return monthNames[x];
    }

    $("#flot-chart1").length && $.plot($("#flot-chart1"), [{
        data: d11,
        label: "BCF Bridge"
    }, {
        data: d12,
        label: "Boshila Bridge"
    }, {
        data: d13,
        label: "Chandni Ghat"
    }],
